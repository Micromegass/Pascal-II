...
function AddiereBinBaum2(var inBaum:tRefBinBaum; inZahl:integer):integer;
begin 
if inBaum <> nil then 

AddiereBinBaum2 := inZahl + inBaum^.info + AddiereBinBaum2(inBaum^.rechts, (inZahl)) + AddiereBinBaum2(inBaum^.links,  (inZahl) )
